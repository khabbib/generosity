...
export class DashboardComponent implements OnInit {
  ...
  async loadInitialData(): Promise<void> {
    console.log(
      'Initial load - Clearing local storage and fetching data from DB.'
    );
  ...
  filterAndSetDonationData(): void {
    ...
    this.donationsData = this.supabaseService.filterPaymentsByTimeFrame(
      allData,
      this.currentFrame
    );
    console.log(
      `Filtered donationsData for ${this.currentFrame}: `,
      this.donationsData
    );
    this.updateCharts();
  }
